...
Below are some notes on how to build Syndicate Classic for Windows.

The options known to work for building Syndicate Classic on Windows are:

* On Linux using the [Mingw-w64](https://mingw-w64.org/doku.php) cross compiler tool chain. Ubuntu Trusty 14.04 is recommended
and is the platform used to build the Syndicate Classic Windows release binaries.
...
for Ubuntu Xenial does not produce working executables for some of the Syndicate Classic applications.
...
Note that for WSL the Syndicate Classic source path MUST be somewhere in the default mount file system, for
