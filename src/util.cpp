...
{
    std::string strCopyrightHolders = strPrefix + "The Syndicate Classic developers";

    // Check for untranslated substitution to make sure Syndicate Classic copyright is not removed by accident
//    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Syndicate Classic") == std::string::npos) {
//        strCopyrightHolders += "\n" + strPrefix + "The Syndicate Classic developers";
//    }
